...
def create_app(orchestrator=None) -> FastAPI:
    ...
    from muse.api.routes import chat, tasks, permissions, settings, skills, sessions, oauth, files, mcp, memories, screen, recipes
    ...
    app.include_router(recipes.router, prefix="/api", dependencies=_AUTH)
